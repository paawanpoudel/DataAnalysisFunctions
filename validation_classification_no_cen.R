...
validation_classification_no_centring <- function(my_files, pam.centroids, output_dir, info, sample_info){
  ...
  save( anno.Dat, file = paste0( output_dir,"/",info ,"_sample_classification.rda") )
